 ...
 * @version: 
 * @Author: BurNing
 * @Date: 2020-12-03 14:27:31
 * @LastEditors: BurNing
 * @LastEditTime: 2020-12-08 16:18:27
-->
  ...
  <div>
    <div>
      ...
      <el-table @select="rowclick" :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="typemachine" label="颜色描述" width="110">
        </el-table-column>
        <el-table-column prop="needle" label="颜色配比" width="90">
        </el-table-column>
