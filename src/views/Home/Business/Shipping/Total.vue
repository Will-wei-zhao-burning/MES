 ...
 * @version: 
 * @Author: BurNing
 * @Date: 2020-12-22 15:33:46
 * @LastEditors: BurNing
 * @LastEditTime: 2020-12-24 11:00:25
-->
<template>
  <div id="plan">
    <div class="text-left">
      <!-- 预览弹框区 -->
        <el-row><el-table border :data="selectionData">
            ...
            <el-table-column :label="'2020年'+item+'月下单'" v-for="item in selectionData.length" :key="item.index">
                <el-table-column label="出货数量(双)" prop="number"></el-table-column>
                <el-table-column label="出货金额(客户)" prop="number"></el-table-column>
            </el-table-column>
        </el-table></el-row>
    </div>
  </div>
...
export default {
  data() {
    return {
      ...
      selectionData:[{ number: 2, sample: "wqwqwqw" },
        { number: 2, sample: "wqwqwqw" },
        { number: 2, sample: "wqwqwqw" }],
